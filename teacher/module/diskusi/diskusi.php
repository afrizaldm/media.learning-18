            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading" id="accordion">
                        ...
                        <span class="pull-right"><?echo gmdate("Y-m-d H:i:s", time()+60*60*7);?></span>
                    </div>
                        ...
                        <div class="panel-footer">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="waktu" id="waktu" value="<?php echo gmdate("Y-m-d H:i:s", time()+60*60*7); ?>" readonly=""/>
