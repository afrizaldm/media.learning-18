...
INSERT IGNORE INTO `chatbox` (`id_chatbox`, `userid`, `chat`, `waktu`) VALUES
...
-- Dumping data for table medilearn.jawaban: ~0 rows (approximately)
...
-- Dumping data for table medilearn.media: ~0 rows (approximately)
/*!40000 ALTER TABLE `media` DISABLE KEYS */;
INSERT IGNORE INTO `media` (`id_materi`, `userid`, `tema`, `nama_materi`, `materi`, `file_materi`, `file_tugas`, `file_video`, `status`) VALUES
	(2, '14421028', 'Fisika', 'testing', '<p>testing</p>', '6723-new-microsoft-word-document---copy.docx', '9147-new-microsoft-word-document.docx', '35260-10-second-video-fail-[360p].mp4', 'ACTIVE');
...
-- Dumping data for table medilearn.respon: ~1 rows (approximately)
...
INSERT IGNORE INTO `users` (`id_user`, `userid`, `first_name`, `last_name`, `alamat`, `email`, `username`, `password`, `level`) VALUES
