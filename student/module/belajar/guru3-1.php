    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Halaman Literasi (Tetra Rahayu)</div>
                <input type="hidden" name="idguru" value="14421026">
                <div class="panel-body">
                <?php 
                include '../config/connection.php';
                $link = 'index.php?page=info';
                $no = 1;
                $query = "SELECT * FROM media WHERE userid = '14421026' AND tema = 'Literasi'";
                    ...
                    <center>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100" style="border: 1px solid #cccccc; padding: 20px; margin-bottom: 25px">
                                <img class="card-img-top" src="../file/images/ear.png" alt="Card image cap" style="margin-top: 20px;width: 20%;">
                                <div class="card-body">
                                ...
                                <div class="card-footer" style="margin: 10px;">
                                    <a href="<?php echo $link ?>&id=<?php echo $id_materi ?>" class="btn btn-primary">Baca Materi</a>
                                </div>
                            </div>
                        </div>
                    </center>
