<section>
	...
	<form role="search" action="index.php?page=pg1" method="POST">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">Halaman Fisika (Dhea Lintang Suswandana)</div>
				...
				if(isset($_POST['cari'])){
					$cari = $_POST['cari'];
					$data = "SELECT * FROM v_belajar WHERE nama_materi LIKE '%".$cari."%' AND first_name='Dhea'";
