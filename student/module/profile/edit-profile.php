                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-5">
                                    <center>
                                        ...
                                        <h2>Ubah Informasi Akun Pengguna</h2>
                                    </center>
                                </div>
                                ...
                                <div class="col-lg-offset-5">
                                    <form method="POST" id="frm-add-category" name="form1" action="edit_profile.php">
                                        ...
                                        <div class="form-group btn-ch-profile" style="padding: 10px;">
                                            <a href="index.php?page=profile" class="btn btn-warning">Batal</a>
                                            <input type="submit" name="simpan" class="btn btn-success" id="simpan" value="Simpan">
                                        </div>
                                    </form>
                                </div>
                            </div>
